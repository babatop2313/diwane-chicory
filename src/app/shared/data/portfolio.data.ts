...
export const PORTFOLIO_ITEMS: PortfolioItem[] = [
  {
    id: 1,
    titleFr: 'Café Touba - Événement JOJ 2026',
    titleEn: 'Café Touba - JOJ 2026 Event',
    category: 'coffee',
    categoryLabelFr: 'Coffee Shop',
    categoryLabelEn: 'Coffee Shop',
    image: 'assets/images/portfolio/coffee-1.jpg',
    descriptionFr: 'Service Café Touba pour les Jeux Olympiques de la Jeunesse',
    descriptionEn: 'Café Touba service for the Youth Olympic Games',
  },
  {
    id: 2,
    titleFr: 'Production Audiovisuelle - Cérémonie Officielle',
    ...
    descriptionFr: 'Captation 4K d\'une cérémonie officielle à Dakar',
    descriptionEn: '4K capture of an official ceremony in Dakar',
  },
  {
    id: 3,
    titleFr: 'Impression T-shirts - Équipe DCS',
    ...
    descriptionFr: 'Collection T-shirts et mugs personnalisés DCS',
    descriptionEn: 'DCS custom T-shirts and mugs collection',
  },
  {
    id: 4,
    titleFr: 'Décoration Espace Bureau DCS',
    titleEn: 'DCS Office Space Decoration',
    category: 'decoration',
    categoryLabelFr: 'Décoration',
    categoryLabelEn: 'Decoration',
    image: 'assets/images/portfolio/deco-1.jpg',
    descriptionFr: 'Aménagement et branding du siège DCS',
    descriptionEn: 'Layout and branding of DCS headquarters',
  },
  {
    id: 5,
    titleFr: 'Café Touba - Grand Magal de Touba',
    titleEn: 'Café Touba - Grand Magal de Touba',
    category: 'coffee',
    categoryLabelFr: 'Coffee Shop',
    categoryLabelEn: 'Coffee Shop',
    image: 'assets/images/portfolio/coffee-2.jpg',
    descriptionFr: 'Service mobile Café Touba au Grand Magal',
    descriptionEn: 'Mobile Café Touba service at Grand Magal',
  },
  {
    id: 6,
    titleFr: 'Montage - Court-Métrage Documentaire',
